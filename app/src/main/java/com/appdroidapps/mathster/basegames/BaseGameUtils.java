...
public class BaseGameUtils {
    ...
    public static boolean resolveConnectionFailure(Activity activity,
        ...
        if (result.hasResolution()) {
            ...
            // not resolvable... so showQuestion an error message
            ...
            if (dialog != null) {
                ...
                // no built-in dialog: showQuestion the fallback error message
    ...
    public static void showActivityResultError(Activity activity, int requestCode, int actResp, int errorDescription) {
        if (activity == null) {
            Log.e("BaseGameUtils", "*** No Activity. Can't showQuestion failure dialog!");
            return;
        }
        Dialog errorDialog;
