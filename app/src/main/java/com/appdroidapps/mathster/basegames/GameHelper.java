...
package com.appdroidapps.mathster.basegames;
...
public class GameHelper implements GoogleApiClient.ConnectionCallbacks,
    ...
    // Should we showQuestion error dialog boxes?
    ...
    static final int DEFAULT_MAX_SIGN_IN_ATTEMPTS = 100;
    ...
    // Set whether to showQuestion error dialogs or not.
    ...
    public void onActivityResult(int requestCode, int responseCode,
        ...
        if (responseCode == Activity.RESULT_OK) {
            ...
            // solved. So give up and showQuestion an error message.
     ...
     * may showQuestion up. At the end of the process, the GameHelperListener's
...
//        editor.commit();
    ...
    void resolveConnectionResult() {
        ...
        if (mConnectionResult.hasResolution()) {
            ...
            // It's not a problem what we can solve, so give up and showQuestion an
            // error.
    ...
    public static void showFailureDialog(Activity activity, int actResp,
                                         int errorCode) {
        if (activity == null) {
            Log.e("GameHelper", "*** No Activity. Can't showQuestion failure dialog!");
            return;
        }
